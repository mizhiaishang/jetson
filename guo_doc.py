...
def image_information(r1,obs,car):
        ...
        folder_name = f"/home/nvidia/mf/test_file/semantic_graphs/detection_{timestamp}"
        os.makedirs(folder_name, exist_ok=True)

        cv2.imwrite(f"{folder_name}/result.jpg", img_2)
        cv2.imwrite(f"{folder_name}/result_orin.jpg", img1)
        cv2.imwrite(f"{folder_name}/result_orin_plot.jpg", img)
